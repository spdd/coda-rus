...
zk-SNARKs - это итерация доказательств с нулевым знанием, а точнее криптографическая схема, в которой нулевое знание передается верификатору при предоставлении им доказательства вычисления.
