...
# Начало
  ...
  Текущий статус тестовой сети **ОНЛАЙН** - Фаза 3 тестнета запущена! Мы будем оповещать об анонсах в нашем [Discord сервере](https://bit.ly/CodaDiscord) в канале #announcements, а также через электронную почту, когда сеть будет запущена.
