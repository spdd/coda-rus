...
Как только вы освоитесь с основами создания адреса(открытый ключ), отправки и получения coda, можно перейти к действительно уникальным особенностям сети Coda - [участвовать в консенсусе и помогать сжимать блокчейн](/docs/node-operator).
